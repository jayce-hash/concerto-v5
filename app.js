(() => {
      ...
      w.innerHTML = `
        ...
        <div class="form-grid two">
          <div>
            ...
            <select id="eatWhen">
              <option value="before"${sel(state.eatWhen==="before")}>Before the show</option>
              <option value="after"${sel(state.eatWhen==="after")}>After the show</option>
          ...
          <div>
            ...
            <select id="placeStyle">
              <option value="sitdown"${sel(state.placeStyle==="sitdown")}>Sit-down</option>
              <option value="fast"${sel(state.placeStyle==="fast")}>Fast-casual / Quick</option>
              <option value="bar"${sel(state.placeStyle==="bar")}>Bar / Lounge</option>
              <option value="dessert"${sel(state.placeStyle==="dessert")}>Dessert / Cafe</option>
            </select>
          </div>
          <div class="full">
  ...
  function renderResults(plan){
    ...
    if (state.showTime){
      ...
      const pre = (state.eatWhen!=="after") ? `Pre-show dinner around ${t}` : null;
